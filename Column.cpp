...
std::shared_ptr<Scalar> Column::element(long index) {
...
ColumnIterator Column::end() {
    ...
    */
    ...
    return ColumnIterator(array_, endChunkIndex, endChunkEndIndex);
}

std::vector<std::shared_ptr<::arrow::ChunkedArray>>
Column::columnVectorToArrowChunkedArrayVector(const std::vector<std::shared_ptr<Column>> &columns) {
